...
angular.module('meanshopApp').controller('ProductsCtrl', function ($scope, Product) {
...
}).constant('clientTokenPath', '/api/braintree/client_token').controller('ProductCheckoutCtrl', function ($scope, $http, $state, ngCart) {
  $scope.errors = '';
